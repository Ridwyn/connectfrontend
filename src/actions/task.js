...
export const getAssignedTasks = async(payload) =>{
    let res = await  axios.get(`${server}/api/task/getAssignedTasks`,{headers:{authorization:localStorage.getItem('token').split('"')[1]}})
    return res.data
};
